  ...
  <div class="container">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body input-profile">
        ...
        <div class="row"><div class="col-md-3"><strong>School</strong></div><div class="col-md-5"><?php echo $student->schoolName; ?></div><div class="col-md-4"><button id="editSchool" type="button" class="btn btn-default btn-md pull-right" data-toggle="modal" data-target="#editSchoolModal">Edit School/Modules</button><br><br></div></div>
        <div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="editModuleForm" type="get" action="#">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          <button id="moduleSubmit2" type="submit" class="btn btn-primary">Save changes</button>
        </div> 
