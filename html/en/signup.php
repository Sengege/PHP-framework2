				...
				<div id="stepTwo" style="display:none" >
					...
					<div class="col-md-12">
						...
						<div id="stepTwoContent" style="display:none;">
							...
							<p></p>
							<button type="button"  class="btn btn-default" onclick="changePage(1);" class="" id="back">Back</button>
		...
		$("#newStudent").validate({
					...
					submitHandler: function(form) {
							...
							if(newStudent["universityChosen"] == false || (newStudent["universityChosen"] == true && newStudent["university"] != choosenUniversityID ))
							{
								...
								$("#firstSubmit").html('Please Wait <i class="fa fa-spinner fa-pulse"></i>');
			...
			$("#submitAll").click(function(e){
				...
				$("#submitAll").html('Please Wait <i class="fa fa-spinner fa-pulse"></i>');
