...
function addNotificationInc($notificationType, $groupID, $studentID, $meetingID) {
	...
	if($meetingID != null){
	    ...
	    if($notificationType !== "New Meeting"){
        ...
        $notifyingMembers = $meetingMembers->fetchAll();
         ...
         // Get all users of that group excluding notifying member(new meeting for group but has meeting id)
