			...
			<h1>Add Student</h1>
				...
				<div id="stepOne">
					...
					<div class="col-md-6">	
								...
								<br>
								<button class="btn btn-default" id="firstSubmit" type="submit">Next</button>
				...
				<div id="stepTwo" style="display:none" >
					...
					<div class="col-md-12">
						...
						<button type="button" class="btn btn-default" disabled="disabled" class="btn btn-primary" id="submitAll">Select at least 3 modules</button>
						</div>
					</div>
		...
		$("#newStudent").validate({
					...
					submitHandler: function(form) {
							...
							if(newStudent["universityChosen"] == false || (newStudent["universityChosen"] == true && newStudent["university"] != choosenUniversityID ))
							{
								...
								$("#firstSubmit").html('Please Wait <i class="fa fa-spinner"></i>');
			...
			$("#submitAll").click(function(e){
				...
				$("#submitAll").html('Please Wait <i class="fa fa-spinner"></i>');
