...
function addUser() {
	...
	$insertQuery = "INSERT INTO `students`(`universityID`, `schoolID`, `first_name`, `last_name`, `DOB`, `email`, `username`, `password`, `salt`,`secure_password`,`type`) VALUES (:universityID, :schoolID, :first_name, :last_name, :DOB, :email, :username, :password, :salt,:secure_password,:language)";
