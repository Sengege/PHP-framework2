					...
					<div class="col-md-6">
						  ...
						  <!-- Example row of columns -->
							...
							<select name="university" id="university" style="padding:5px;display:block;">
								...
								?>
								<option value="notListed">不上市？</option>
							</select>
				...
				<div id="stepTwo" style="display:none" >
					...
					<div class="col-md-12">
						<div id="stepTwoContent" style="display:none;">
							...
							<p></p>
							<button type="button" onclick="changePage(1);" class="" id="back">背部</button>
	...
	<script>
		...
		$("#newStudent").validate({
				...
				$.get( "/scripts/modules/"+universityID, function( data ) {
					...
					if(validUniversity)
					{
						if(numberOfSchools == 0)
						{
							...
							bootbox.alert("<p><strong>警告</strong><br/>"+universityName+" 没有部门</p>");
						}
			...
			function populateSchools()
			{
				...
				$("#schoolOptions").empty();
				$("#schoolOptions").append('<option value="">选择部门</option>');
